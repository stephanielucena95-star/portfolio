            ...
            <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-20">
                <div>
                    ...
                    <div className="flex flex-col">
                        <div className="sticky top-32 relative aspect-square w-full max-w-md mx-auto lg:mx-0 rounded-[3rem] overflow-hidden border border-white/10 shadow-2xl group">
                            <img
